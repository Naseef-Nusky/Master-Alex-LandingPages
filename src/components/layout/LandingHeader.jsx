    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-3 py-2.5 sm:gap-3 sm:px-6 sm:py-3.5">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          <a
            href={SITE.phoneLink}
            className="btn-touch inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-xl border border-white/15 bg-white/5 px-3 py-2 text-xs font-semibold text-white transition hover:border-master-gold/40 hover:text-master-gold-light md:hidden"
          >
          ...
          <a
            href="/#consultation"
            className="btn-gold btn-touch inline-flex min-h-[44px] items-center justify-center rounded-xl px-3 py-2 text-xs font-bold text-master-dark sm:px-4 sm:text-sm"
          >
