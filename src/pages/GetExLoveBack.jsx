...
export default function GetExLoveBack() {
  return (
    <LandingServiceLayout
      ...
      subtitle="Reconnect with true love through London's trusted love back expert. Master Alex helps you rebuild the bond you once shared and bring your ex back."
      serviceSlug="get-ex-love-back"
      serviceImage="/get-ex-love-back.png"
      intro={[
        {
